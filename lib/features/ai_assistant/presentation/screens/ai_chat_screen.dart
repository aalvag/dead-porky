...
class ChatNotifier extends StateNotifier<ChatState> {
  ...
  Future<void> _streamRealResponse(
    ...
    final systemContext = KiloGatewayReal.buildHealthContext(
      ...
      averageHeartRate: wearableMetrics?.averageHeartRate,
      activeMinutes: wearableMetrics?.activeMinutes,
      caloriesBurned: wearableMetrics?.caloriesBurned,
      distanceKm: wearableMetrics?.distanceKm,
      floorsClimbed: wearableMetrics?.floorsClimbed,
      workoutsToday: wearableMetrics?.workoutsToday,
      bloodOxygen: wearableMetrics?.bloodOxygen,
      respiratoryRate: wearableMetrics?.respiratoryRate,
      heartRateVariabilityMs: wearableMetrics?.heartRateVariabilityMs,
      deepSleepHours: wearableMetrics?.deepSleepHours,
      lightSleepHours: wearableMetrics?.lightSleepHours,
      remSleepHours: wearableMetrics?.remSleepHours,
